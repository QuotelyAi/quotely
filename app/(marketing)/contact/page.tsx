    ...
    <div className="min-h-screen bg-white dark:bg-gray-950 py-12 transition-colors duration-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="bg-gray-50 dark:bg-gray-900 rounded-lg shadow-lg p-8 border border-gray-200 dark:border-gray-800">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900 dark:text-white mb-1">Sales Inquiries</h3>
                    <p className="text-gray-600 dark:text-gray-400">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900 dark:text-white mb-1">AI Available 24/7</h3>
                    <p className="text-gray-600 dark:text-gray-400">
          ...
          {/* Map */}
          <div className="bg-gray-50 dark:bg-gray-900 rounded-lg shadow-lg overflow-hidden h-full min-h-[450px] border border-gray-200 dark:border-gray-800">
            <iframe
        ...
        <div className="mt-12 bg-gray-50 dark:bg-gray-900 rounded-lg p-8 border border-gray-200 dark:border-gray-800">
          <div className="grid md:grid-cols-3 gap-8 text-center">
            <div>
              <h3 className="font-bold text-gray-900 dark:text-white mb-2">Platform Support</h3>
              <p className="text-gray-600 dark:text-gray-400">
                Technical support available for all platform users
              </p>
            </div>
            <div>
              <h3 className="font-bold text-gray-900 dark:text-white mb-2">Custom Token Packages</h3>
              <p className="text-gray-600 dark:text-gray-400">
                Volume pricing available for high-volume agencies
              </p>
            </div>
            <div>
              <h3 className="font-bold text-gray-900 dark:text-white mb-2">Partner Network</h3>
              <p className="text-gray-600 dark:text-gray-400">
