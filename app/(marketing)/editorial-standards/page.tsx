...
export default function EditorialStandardsPage() {
  return (
    <div className="min-h-screen bg-white dark:bg-gray-950 transition-colors duration-200">
      {/* Hero Section */}
      <section className="bg-gradient-to-br from-gray-50 dark:from-gray-900 to-white dark:to-gray-950 py-16 border-b border-gray-200 dark:border-gray-800">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        {/* E-E-A-T Pillars */}
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">Our E-E-A-T Framework</h2>
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-6 border border-gray-200 dark:border-gray-800">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-xl font-semibold text-gray-900 dark:text-white">Authoritativeness</h3>
              </div>
              <p className="text-gray-600 dark:text-gray-400">
            ...
            <div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-6 border border-gray-200 dark:border-gray-800">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-xl font-semibold text-gray-900 dark:text-white">Trustworthiness</h3>
              </div>
              <p className="text-gray-600 dark:text-gray-400">
        ...
        <section className="mb-12" id="fact-checking">
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">Our Fact-Checking Process</h2>
          <div className="bg-gray-50 dark:bg-gray-900 rounded-xl p-8 border border-gray-200 dark:border-gray-800">
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">Author Expertise Requirements</h2>
          <div className="bg-gray-50 dark:bg-gray-900 rounded-xl p-8 border border-gray-200 dark:border-gray-800">
            <div className="space-y-4">
        ...
        <section className="mb-12" id="authors">
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">Our Authors & Experts</h2>
          <div className="space-y-6">
            {authors.map((author) => (
              <div key={author.id} className="bg-gray-50 dark:bg-gray-900 rounded-xl p-6 border border-gray-200 dark:border-gray-800">
                    ...
                    <div className="mb-4">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {author.credentials.map((credential, index) => (
                          <span
                            key={index}
                            className="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-gray-200 dark:bg-gray-800 text-gray-700 dark:text-gray-300"
                          >
                            {credential}
                          </span>
                        ))}
        ...
        <section className="mb-12" id="sources">
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">Our Authoritative Sources</h2>
          ...
          <div className="space-y-4">
            {['regulatory', 'government', 'industry', 'professional', 'research'].map((category) => {
              ...
              return (
                <div key={category} className="bg-gray-50 dark:bg-gray-900 rounded-lg p-6 border border-gray-200 dark:border-gray-800">
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">Content Update Policy</h2>
          <div className="bg-gray-50 dark:bg-gray-900 rounded-xl p-8 border border-gray-200 dark:border-gray-800">
            <div className="flex items-center gap-3 mb-4">
              <RefreshCw className="w-6 h-6 text-yellow-500" />
              <p className="text-lg font-semibold text-gray-900 dark:text-white">{editorialGuidelines.updatePolicy.frequency}</p>
            </div>
            <p className="text-gray-600 dark:text-gray-400 mb-4">Content updates are triggered by:</p>
            ...
            <p className="text-sm text-gray-500 mt-4 pt-4 border-t border-gray-200 dark:border-gray-800">
        ...
        {/* Transparency */}
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">Transparency & Disclosure</h2>
          <div className="bg-gray-50 dark:bg-gray-900 rounded-xl p-8 border border-gray-200 dark:border-gray-800">
            <div className="space-y-4">
        ...
        {/* Contact */}
        <section>
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">Contact Our Editorial Team</h2>
          <div className="bg-gray-50 dark:bg-gray-900 rounded-xl p-8 border border-gray-200 dark:border-gray-800">
            ...
            <div className="space-y-2">
              ...
              <p className="text-gray-700 dark:text-gray-300">
                <strong className="text-gray-900 dark:text-white">Response Time:</strong> Within 2 business days
              </p>
            </div>
            <div className="mt-6 flex gap-4">
              ...
              <Link
                href="/blog"
                className="inline-flex items-center justify-center px-6 py-3 border border-gray-300 dark:border-gray-600 text-gray-900 dark:text-white font-semibold rounded-lg hover:bg-gray-200 dark:hover:bg-gray-800 transition-colors"
              >
                Read Our Blog
              </Link>
            </div>
