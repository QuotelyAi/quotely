...
const faqs = [
  ...
  },
  {
    ...
    a: "Connect runs fully standalone — no AMS or CRM required. If you need a Quotely-provisioned AMS, CRM, and managed Gail + Momentum, see the Starter plan.",
  },
  {
...
function CellValue({ value }: { value: boolean | string }) {
  ...
  if (value === false) return <span className="text-gray-400 dark:text-gray-600">—</span>;
    ...
    <div className="min-h-screen bg-white dark:bg-gray-950 transition-colors duration-200">
      ...
      <section className="py-20 px-4 text-center">
        <div className="max-w-4xl mx-auto">
          <div className="inline-flex items-center gap-2 rounded-full bg-yellow-500/10 border border-yellow-500/20 px-4 py-1.5 mb-6">
            ...
            <span className="text-xs font-semibold text-yellow-500 uppercase tracking-wide">Now Available</span>
          </div>
      ...
      <section className="py-12 px-4 border-t border-gray-200 dark:border-gray-800">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white text-center mb-10">Who it&apos;s for</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <div key={title} className="rounded-xl border border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-900 p-6">
      ...
      <section className="py-16 px-4">
        <div className="max-w-2xl mx-auto">
          <div className="relative rounded-2xl border border-yellow-500 bg-gray-50 dark:bg-gray-900 p-10">
            ...
            <div className="flex items-baseline gap-2 mb-1">
              ...
              <span className="text-gray-500 text-sm">/agent/month</span>
            </div>
            ...
            <ul className="space-y-3 mb-8">
              {[
                ...
                'No AMS, CRM, or Voice included — standalone quoting only',
      ...
      <section className="py-16 px-4 border-t border-gray-200 dark:border-gray-800">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-3xl font-bold text-gray-900 dark:text-white text-center mb-10">Compare Plans</h2>
          <div className="overflow-x-auto">
            <table className="w-full bg-gray-50 dark:bg-gray-900 rounded-xl overflow-hidden border border-gray-200 dark:border-gray-800 text-sm">
              <thead>
                <tr className="bg-gray-100 dark:bg-gray-800">
                  <th className="px-6 py-4 text-left font-semibold text-gray-900 dark:text-white w-2/5">Feature</th>
                  <th className="px-5 py-4 text-center font-semibold text-yellow-500">
                    Connect
                    <br />
                    <span className="font-normal text-gray-500 text-xs">$299/agent/mo</span>
                  </th>
                  <th className="px-5 py-4 text-center font-semibold text-gray-900 dark:text-white">
                    Starter
                    <br />
                    <span className="font-normal text-gray-500 text-xs">$999/mo</span>
                  </th>
                  <th className="px-5 py-4 text-center font-semibold text-gray-900 dark:text-white">
                    Professional
                    <br />
                    <span className="font-normal text-gray-500 text-xs">$1,799/mo</span>
                  </th>
                </tr>
              </thead>
              <tbody>
      ...
      <section className="py-16 px-4 border-t border-gray-200 dark:border-gray-800">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-3">
            {faqs.map(({ q, a }, i) => (
              <div key={i} className="rounded-xl border border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-900 overflow-hidden">
                <button
                ...
                {openFaq === i && (
                  <div className="px-6 pb-5 pt-4 text-sm text-gray-600 dark:text-gray-400 leading-relaxed border-t border-gray-200 dark:border-gray-800">
                    {a}
                  </div>
                )}
              </div>
      ...
      <section className="py-20 px-4 border-t border-gray-200 dark:border-gray-800">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link
              href="/demo-request"
              className="px-8 py-4 rounded-xl border border-gray-300 dark:border-gray-700 text-gray-900 dark:text-white font-semibold text-base hover:border-yellow-500 hover:text-yellow-600 dark:hover:text-yellow-400 transition-colors"
            >
              Talk to Sales
            </Link>
          </div>
