        ...
        <div className="bg-gray-50 dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-800 p-8 space-y-6">
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2 text-gray-700 dark:text-gray-300">
              <li><strong className="text-gray-900 dark:text-white">Essential Cookies:</strong> Required for the platform to function properly, including authentication and session management</li>
              <li><strong className="text-gray-900 dark:text-white">Analytics Cookies:</strong> Help us understand how users interact with our platform to improve user experience</li>
              <li><strong className="text-gray-900 dark:text-white">Preference Cookies:</strong> Remember your settings and preferences for a personalized experience</li>
              <li><strong className="text-gray-900 dark:text-white">Performance Cookies:</strong> Monitor platform performance and optimize quote generation speed</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <div className="space-y-4">
              ...
              <div>
                <h3 className="font-semibold text-gray-900 dark:text-white mb-2">Third-Party Cookies</h3>
                <p className="text-gray-700 dark:text-gray-300">
          ...
          <section className="pt-6 border-t border-gray-300 dark:border-gray-800">
